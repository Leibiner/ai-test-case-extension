...
- **质量检查**：生成后做本地检查，提示字段缺失、重复标题、步骤过短、模糊预期等问题。
- **XMind 友好导出**：导出层级 Markdown，可用于 XMind 导入和评审沉淀。
...
这是一个可本地安装试用的 MVP，已经具备完整侧边栏交互、模型配置、澄清问答、测试用例生成、质量检查和 XMind Markdown 导出能力。
